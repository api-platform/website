    ...
    <div className="container seo__container">
      ...
      <div className="seo__content">
        <p>
          ...
          markup to websites and apps increase their ranking in search engines
          results and enable awesome features such as{' '}
          <a
        ...
        <p>
          ...
          DOM: <strong>it’s a matter of minutes before being SEO Ready</strong>.
        </p>
        <p className="hidden-small">
          Schema.org improves the interoperability of your applications. Used
          with hypermedia technologies such as{' '}
          <a
            href="http://www.hydra-cg.com/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Hydra
          </a>{' '}
          it&#39;s a big step towards the semantic and machine readable web. It
          opens the way to generic web API clients able to extract and process
          data from any website or app using such technologies.
        </p>
      </div>
    </div>
  </section>
