...
// import DocMenu from '../docs/DocMenu';
...
class DocNav extends Component {
  ...
  // handleScroll() {
  //   if (
  //     document.querySelectorAll('.Collapsible.submenu__item.open')[0] ===
  //     undefined
  //   ) {
  //     return;
  //   }

  //   const currentItemOpen = document.querySelectorAll(
  //     '.Collapsible.submenu__item.open'
  //   )[0];
  //   const childsCurrentItem = currentItemOpen.querySelectorAll('a');
  //   const childsInnerPageItem = [];
  //   childsCurrentItem.forEach((child, index) => {
  //     childsInnerPageItem[index] = document.getElementById(
  //       child.getAttribute('href').split('#')[1]
  //     );
