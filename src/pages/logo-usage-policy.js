  ...
  <Layout location={props.location}>
    <div className="logo-policy">
      ...
      <div className="container card">
        ...
        right to revoke its approval of your use of the logos at any time.
        Permission is granted to you to use the Logos only on the following
        conditions :`}
        </p>
        <h2>Rules for Using the Logos</h2>
        <p>You must comply with all of the following rules when using a Logo:</p>
        <ul>
          <li>Logos may not be used in any confusing way.</li>
          <li>
            No Logo may be used in any way that suggests that API Platform is affiliated with, sponsors, approves or endorses
            you, your organization, your websites, your products or your services, unless such a relationship exists.
          </li>
          <li>No Logo may be used in any way that mischaracterizes any relationship between you and API Platform</li>
          <li>
            No Logo may be used or displayed in any of the following ways:
            <ol>
              <li>
                in any manner that, in the sole discretion of API Platform, discredits API Platform or tarnishes its
                reputation and goodwill
              </li>
              <li>
                in any manner that infringes, dilutes, depreciates the value, or impairs the rights of API Platform in
                the Logos;
              </li>
              <li>in any manner that is false or misleading</li>
              <li>
                in connection with any pornography, illegal activities, or other materials that are defamatory,
                libelous, obscene, or otherwise objectionable
              </li>
              <li>
                in any manner that violates the trademark, copyright or any other intellectual property rights of others
              </li>
              <li>in any manner that violates any law, regulations, or other public policy</li>
              or as part of a name of an other product or service than API Platform.
            </ol>
          </li>
          <li>
          ...
          <li>
            You may not assert rights to any Logo whether by trademark registration, domain name registration or
            anything else.
          </li>
          <li>You must make any changes to your use of the Logos that are requested by API Platform.</li>
        </ul>
        <p>
          If you’d like to make any use of our Logos that is not covered by this policy, or for further information or
          clarification about use of the Logos, please contact <a href="#">dunglas@gmail.com</a>.
        </p>
      </div>
    </div>
  </Layout>
