const footer = [
  {
    ...
    links: [
      ...
      {
        title: "footer.previous_edition.links.all",
        link: "/{{locale}}/con/editions/",
      },
    ],
  },
  {
    ...
    links: [
      {
        ...
        link: "/{{locale}}/con/2023/speakers",
      },
      {
        title: "footer.the_event.links.schedule",
        link: "/{{locale}}/con/2023/schedule",
      },
      {
        title: "footer.the_event.links.venue",
        link: "/{{locale}}/con/2023/#venue",
      },
      {
    ...
    links: [
      {
        ...
        link: "/{{locale}}/con/2023/code-of-conduct",
      },
      {
        title: "footer.legal.links.faq",
        link: "/{{locale}}/con/2023/faq",
      },
      {
        title: "footer.legal.links.transparency",
        link: "/{{locale}}/con/2023/transparency",
      },
    ],
  },
];
