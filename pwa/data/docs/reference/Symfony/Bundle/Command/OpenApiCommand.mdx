...
# [ApiPlatform\OpenApi\Command\OpenApiCommand](/docs/reference/OpenApi/Command/OpenApiCommand)
...
{
    public __construct(ApiPlatform\OpenApi\Factory\OpenApiFactoryInterface $openApiFactory, Symfony\Component\Serializer\Normalizer\NormalizerInterface $normalizer)
...
<table><tbody>
<tr><td>openApiFactory</td><td>ApiPlatform\OpenApi\Factory\OpenApiFactoryInterface</td><td></td></tr><tr><td>normalizer</td><td>Symfony\Component\Serializer\Normalizer\NormalizerInterface</td><td></td></tr>
</tbody>
</table>
