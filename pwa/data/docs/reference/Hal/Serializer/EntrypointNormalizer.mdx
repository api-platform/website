...
# [ApiPlatform\Hal\Serializer\EntrypointNormalizer](/docs/reference/Hal/Serializer/EntrypointNormalizer)

Normalizes the API entrypoint.


```php
class ApiPlatform\Hal\Serializer\EntrypointNormalizer implements Symfony\Component\Serializer\Normalizer\NormalizerInterface, Symfony\Component\Serializer\Normalizer\CacheableSupportsMethodInterface
{
