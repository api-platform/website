...
Learn more about custom formats in the [dedicated guide](/docs/guide/custom-formats).
...
For more examples, read our guide on [subresources](/docs/guide/subresources).
