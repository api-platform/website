...
# [ApiPlatform\Doctrine\Orm\Filter\ExistsFilter](/docs/reference/Doctrine/Orm/Filter/ExistsFilter)
...
```php
class ApiPlatform\Doctrine\Orm\Filter\ExistsFilter extends ApiPlatform\Doctrine\Orm\Filter\AbstractFilter implements `<a href="/docs/reference/Doctrine/Orm/Filter/FilterInterface">ApiPlatform\Doctrine\Orm\Filter\FilterInterface</a>`, `<a href="/docs/reference/Metadata/FilterInterface">ApiPlatform\Metadata\FilterInterface</a>`, `<a href="/docs/reference/Doctrine/Common/Filter/ExistsFilterInterface">ApiPlatform\Doctrine\Common\Filter\ExistsFilterInterface</a>`
{
