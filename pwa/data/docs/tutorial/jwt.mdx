...
<p align="center" className="symfonycasts"><a href="https://symfonycasts.com/screencast/symfony-rest4/json-web-token?cid=apip"><img src="../distribution/images/symfonycasts-player.png" alt="JWT screencast" /><br/>Watch the LexikJWTAuthenticationBundle screencast</a></p>
