...
export default function Preheader() {
  return (
    <>
      ...
      <Link
        className=" border-b-2 border-b-white bg-gradient-to-tr from-[#000] via-blue-darkest z-50 to-[#000] text-white font-bold h-16 md:h-20 w-full text-center relative align-center flex items-center justify-center"
        href="https://www.gofundme.com/f/support-ryans-brain-cancer-battle"
        rel="noopener noreferrer"
        target="_blank"
      >
        <div className="container relative flex flex-row items-center gap-4 pr-11">
          <img
            src="/images/con/2023/speakers/ryan-weaver.png"
            className="h-12 md:h-20 border-white border-2 md:border-4 shadow-md -rotate-3 w-auto translate-y-2"
            alt=""
          />
          ...
          <button className="rounded-3xl bg-pink text-white px-4 py-2 inline-block text-xs relative">
            DONATE
            <img
              alt=""
              src="/images/ryan-heart.png"
              className="hidden md:block h-20 p-0.5 w-auto absolute top-1/2 -translate-y-1/2 left-full translate-x-12"
            />
          </button>
        </div>
      </Link>
