...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: dictionary.review.description.replace("%edition%", "2023"),
    openGraph: {
      title: `${dictionary.review.title} - API Platform Conference 2023`,
      description: dictionary.review.description.replace("%edition%", "2023"),
    },
    twitter: {
      title: `${dictionary.review.title} - API Platform Conference 2023`,
    ...
    alternates: {
      languages: {
        en: locale === "en" ? undefined : "/con/2023/review",
        fr: locale === "fr" ? undefined : "/fr/con/2023/review",
      },
    },
  };
}
...
export default async function Page({ params }: { params: { locale: Locale } }) {
  const images = await getAllEditionPictures("2023");
  return (
    <>
      <Cover />
      {
